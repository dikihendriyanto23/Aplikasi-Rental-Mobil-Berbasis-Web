...
<style type="text/css">
  ...
  <div class="card">
    <div class="card-header"><h3 class="text-center">Detail Transaksi</h3></div>
    <div class="card-body">
      <table class="table table-hover">
          <tbody>
							...
							<?php while ($r = $query->fetch_assoc()): ?>
								...
								<tr>
									<th>Konfirmasi</th>
									<td>: <span class="label label-<?=($r['konfirmasi']) ? "btn btn-success" : "btn btn-danger"?>"><?=($r['konfirmasi']) ? "Sudah" : "Belum"?></span></td>
								</tr>
								<tr>
									<th>Kembali</th>
									<td>: <span class="label label-<?=($r['status']) ? "btn btn-success" : "btn btn-danger"?>"><?=($r['status']) ? "Sudah" : "Belum"?></span></td>
								</tr>
								<tr>
									<th>Pembatalan</th>
									<td>: <span class="label label-<?=($r['pembatalan']) ? "btn btn-danger" : "btn btn-success"?>"><?=($r['pembatalan']) ? "Ya" : "Tidak"?></span></td>
								</tr>
