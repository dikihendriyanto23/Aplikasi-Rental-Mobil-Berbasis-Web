...
<div class="row">
	<div class="col-md-4 d-print-none">
	    <div class="card card-<?= ($update) ? "warning" : "info" ?>">
	        <div class="card-header"><h3 class="text-center"><?= ($update) ? "EDIT MOBIL" : "TAMBAH MOBIL" ?></h3></div>
	        <div class="card-body">
	            <form action="<?=$_SERVER['REQUEST_URI']?>" method="POST" enctype="multipart/form-data">
	                ...
	                <div class="form-group">
	                    ...
	                    <input type="text" name="no_mobil" class="form-control" <?= (!$update) ?: 'value="'.$row["no_mobil"].'"' ?> placeholder="Masukkan No Mobil">
	                </div>
	                <div class="form-group">
	                    <label for="nama_mobil">Nama Mobil</label>
	                    <input type="text" name="nama_mobil" class="form-control" <?= (!$update) ?: 'value="'.$row["nama_mobil"].'"' ?> placeholder="Masukkan Nama Mobil">
	                </div>
	                <div class="form-group">
	                    <label for="merk">Merk</label>
	                    <input type="text" name="merk" class="form-control" <?= (!$update) ?: 'value="'.$row["merk"].'"' ?> placeholder="Masukkan Merek Mobil">
	                </div>
	                <div class="form-group">
	                ...
	                <div class="form-group">
	                    ...
	                    <input type="text" name="harga" class="form-control" <?= (!$update) ?: 'value="'.$row["harga"].'"' ?> placeholder="Masukkan Harga Sewa Mobil">
	                </div>
	                <div class="form-group">
	...
	<div class="col-md-8">
	    <div class="card card-info">
	        <div class="card-header"><h3 class="text-center">DAFTAR MOBIL</h3></div>
	        <div class="card-body">
	                    ...
	                    <?php if ($query = $connection->query("SELECT * FROM mobil JOIN jenis USING(id_jenis)")): ?>
	                        ...
	                        <tr>
	                            ...
	                            <td class="d-print-none">
	                                <div class="btn-group">
	                                    <a href="../assets/img/mobil/<?=$row['gambar']?>" class="btn btn-info btn-sm fancybox">Lihat</a>
	                                    <a href="?page=mobil&action=update&key=<?=$row['id_mobil']?>" class="btn btn-warning btn-sm">Edit</a>
	                                    <a href="?page=mobil&action=delete&key=<?=$row['id_mobil']?>" class="btn btn-danger btn-sm">Hapus</a>
	                                </div>
	                            </td>
	                        </tr>
	                        <?php endwhile ?>
